...
public class ZProcessNodeFrontController extends BaseController {
	...
	public String list(ZProcessNode zProcessNode, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/cms/front/themes/taixhome/actionPage/zprocess/zProcessNodeList";
	}

	@RequestMapping(value = "formDetail")
	public String formDetail(ZProcessNode zProcessNode, HttpServletRequest request, HttpServletResponse response, Model model) {
		zProcessNode = get(zProcessNode.getId());
		model.addAttribute("zProcessNode", zProcessNode);
		return "modules/cms/front/themes/taixhome/actionPage/zprocess/zProcessNodeForm";
	}
