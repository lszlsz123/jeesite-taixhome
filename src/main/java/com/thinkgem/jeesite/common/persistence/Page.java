...
public class Page<T> {
	...
	public String getTaixHomePage() {
		return toString_taixhome();
	}

	public void setTaixHomePage(String taixHomePage) {
		this.taixHomePage = taixHomePage;
	}

	/**
	 * taix home page
	 */
	public String toString_taixhome() {
		...
		sb1.append("<li class=\"fy_h fy_gyxg fy_sy\">"
				+"<a href=\"javascript:\" onclick=\""+funcName+"("+first+","+pageSize+",'"+funcParam+"');\">首页</a>"
				+ "</li>");
		
		for(int i=1; i<=totalPage;i++) {
			int num=i-pageNo;
			String currentPageStyle = (pageNo==i)?"fy_bbg":"";
			if(num<3&&num>-3) {
				sb2.append("<li class=\"fy_h fy_gyxg fy_w\" "+currentPageStyle+">"
				+"<a href=\"javascript:\" onclick=\""+funcName+"("+i+","+pageSize+",'"+funcParam+"');\">"+i+"</a>"
				+ "</li>");
			}
			if(num==-1||num==1) {
				sb1.append("<li class=\"fy_bg\">......</li>");
			}
			
		}
		sb3.append("<li class=\"fy_h fy_gyxg fy_my\">"
				+"<a href=\"javascript:\" onclick=\""+funcName+"("+first+","+pageSize+",'"+funcParam+"');\">末页</a>"
				+ "</li>");
