...
<div id="hp_bg">
  ...
  <div class="mg_content">
    ...
    <div class="mg_mb">
    <form id="searchForm" action="${ctx}/zsys/zAccident/list" method="post" onsubmit="return submitForm();">
	    <div class="zpxx_box clear">
	        <div class="vi_box">
	              <input type="hidden" id=queryCode name="queryCode" value=""/>
	              <input type="hidden" id="accVehcileNum" name="accVehcileNum" value=""/>
	          <ul>
	            <li class="vi_li">
...
function submitForm(){
	...
	$("#accVehcileNum").val($("#text1").val()+$("#text2").val());
// 	if($("#queryCode").val().length<4){
// 		alert("请输入您的车架号后四位");
// 		return false;
// 	}
	if($("#accVehcileNum").val().length<7){
		alert("请输入您的车牌号码");
		return false;
	}
	return true;
