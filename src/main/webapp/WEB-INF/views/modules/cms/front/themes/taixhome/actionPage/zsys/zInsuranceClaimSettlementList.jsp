      ...
      <div class="zpxx_box clear">
        <ul>
        	...
        	<c:forEach items="${page.list}" var="zInsuranceClaimSettlement">
	        	<a href="${ctx}/zsys/zInsuranceClaimSettlement/formDetail?id=${zInsuranceClaimSettlement.id}">
		            <li class="bbm">
		              <span class="zpxx_gyys xq">事故编号：${zInsuranceClaimSettlement.accNum}</span>
		              <span class="zpxx_gyys gsmc">车牌号码：${zInsuranceClaimSettlement.vehicleNum} 事故时间：<fmt:formatDate value="${zInsuranceClaimSettlement.accTime}" pattern="yyyy.MM.dd"/></span>
		              <span class="zpxx_gyys dz"><fmt:formatDate value="${zInsuranceClaimSettlement.updateDate}" pattern="yyyy.MM.dd"/></span>
		            </li>
	          	</a>
          	</c:forEach>
        ...
        <div class="fy_box">
          <ul>
            ...
            <script type="text/javascript">
				function page(n,s){
					location="${ctx}/zsys/zInsuranceClaimSettlement/list?pageNo="+n+"&pageSize="+s+"&vehicleNum=${zInsuranceClaimSettlement.vehicleNum}";
				}
			</script>
          </ul>
        </div>
