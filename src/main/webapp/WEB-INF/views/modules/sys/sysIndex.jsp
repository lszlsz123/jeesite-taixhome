	...
	<div id="main">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By ${fns:getConfig('productName')} ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
...
<!-- 模态框（Modal） -->
<div class="modal fade" id="manualServiceDialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
function checkManualService(){
	$.ajax({
        type: "post",
        url: "${ctx}/zsys/zManualService/findManualServiceList",
        cache: false,
        async : false,
        dataType: "json",
