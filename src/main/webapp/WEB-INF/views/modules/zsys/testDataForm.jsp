...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/zsys/testData/">从业司机业务办理查询列表</a></li>
		<li class="active"><a href="${ctx}/zsys/testData/form?id=${testData.id}">从业司机业务办理查询<shiro:hasPermission name="zsys:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="zsys:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/zsys/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="zsys:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
