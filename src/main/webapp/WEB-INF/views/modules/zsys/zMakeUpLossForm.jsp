...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/zsys/zMakeUpLoss/">证件遗失补办业务列表</a></li>
		<li class="active"><a href="${ctx}/zsys/zMakeUpLoss/form?id=${zMakeUpLoss.id}">证件遗失补办业务<shiro:hasPermission name="zsys:zMakeUpLoss:edit">${not empty zMakeUpLoss.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="zsys:zMakeUpLoss:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="zMakeUpLoss" action="${ctx}/zsys/zMakeUpLoss/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="zsys:zMakeUpLoss:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
